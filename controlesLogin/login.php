...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn instanceof PDO) {
        ...
        $stmt = $conn->prepare("SELECT * FROM empresas WHERE email = :email LIMIT 1");
        ...
        if ($user && password_verify($password, $user['contrasena'])) {
            ...
            header("Location: ../controlerDashboard/dashboard.php"); // Redirigir a un dashboard o página principal
            exit();
        } else {
